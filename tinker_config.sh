...
rm $TARGET_ROOTFS_DIR /etc/apt/sources.list.d/multistrap-ubuntu.list
...
echo deb http://mirrors.tuna.tsinghua.edu.cn/ubuntu-ports/ xenial main restricted universe multiverse > $filename
